...
function AddJobModal() {
  ...
  const inputClass = "text-[18px] text-black border border-t-0 border-gray-200 rounded-[10px] px-3 py-2 w-full focus:outline-none placeholder:text-[#B1B1B1] shadow-[0px_3px_4.3px_-1px_#00000036]";
  const selectClass = (value) => `text-[18px] border border-t-0 border-gray-200 rounded-[10px] px-3 py-2 w-full focus:outline-none shadow-[0px_3px_4.3px_-1px_#00000036] ${value ? 'text-black' : 'text-[#B1B1B1]'}`;
  const textareaClass = (value) => `text-[18px] ${value ? 'text-black' : 'text-[#B1B1B1]'} border border-t-0 border-gray-200 rounded-[10px] px-3 py-2 w-full focus:outline-none placeholder:text-[#B1B1B1] shadow-[0px_3px_4.3px_-1px_#00000036] resize-none`;
          ...
          >
            ...
            >
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className={`${textareaClass(formData.description)} col-span-1 sm:col-span-2`}
              />
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className={`${textareaClass(formData.responsibilities)} col-span-1 sm:col-span-2`}
              />
              <textarea
                name="requirements"
                ...
                onChange={handleChange}
                rows={3}
                className={`${textareaClass(formData.requirements)} col-span-1 sm:col-span-2`}
              />
              <textarea
                name="skills"
                ...
                onChange={handleChange}
                rows={3}
                className={`${textareaClass(formData.skills)} col-span-1 sm:col-span-2`}
              />
              <textarea
                name="benefits"
                ...
                onChange={handleChange}
                rows={3}
                className={`${textareaClass(formData.benefits)} col-span-1 sm:col-span-2`}
              />
              <select
                name="jobType"
              ...
              >
                <option value="" className="text-[#B1B1B1]">Job Type</option>
              ...
              >
                <option value="" className="text-[#B1B1B1]">Experience Level</option>
                <option value="0-1" className="text-black">0-1 year</option>
              ...
              >
                <option value="" className="text-[#B1B1B1]">Location Type</option>
              ...
              <input
                ...
                onChange={handleChange}
                className={`${inputClass} col-span-1 sm:col-span-2 ${formData.applicationDeadline ? 'text-black' : 'text-[#B1B1B1]'}`}
              />
